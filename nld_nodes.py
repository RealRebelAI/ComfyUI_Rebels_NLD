...
class NLDTextToImage:
    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                ...
                "dequant_cache_gb": ("FLOAT", {"default": 1.5, "min": 0.0, "max": 12.0, "step": 0.5}),
            }
        }
    ...
    def generate(self, nld_model, prompt, width, height, steps, guidance, temperature, seed, decode_device="gpu", dequant_cache_gb=1.5):
