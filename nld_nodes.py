...
def patch_text_to_image_for_vram(model):
    ...
    try:
        ...
        # Regex targets the exact math operation causing the OOM
        ...
        if new_src != src:
            ...
            print("[NLD] Applied IN-PLACE CFG math patch (Saved ~1GB+ VRAM).")
        else:
...
class NLDTextToImage:
    ...
    def generate(self, nld_model, prompt, width, height, steps, guidance, temperature, seed, decode_device="gpu"):
